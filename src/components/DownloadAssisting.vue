	...
	<el-container style="margin: 0px">
	  <el-main>
			 <el-row type="flex" class="row-bg" justify="center">
			  <el-col :span="4" style="font-family: Microsoft YaHei;font-size: 30px;margin: 30px;"><div><span>远程协助软件下载</span></div></el-col>
			</el-row>
		  ...
		  <el-divider></el-divider>
			<el-row type="flex" class="row-bg" justify="space-around">
			  <el-col :span="2">
			      ...
			      <img src="../assets/imgs/chrome.png" class="image">
			  ...
			  <el-col :span="2">
			  	<el-card :body-style="{ padding: '5px' }">
			      <img src="../assets/imgs/edge.png" class="image">
			      <div style="padding: 14px;">
			        <span>Edge</span>
			        <div class="bottom clearfix">
			  ...
			  <el-col :span="2">
			  	<el-card :body-style="{ padding: '5px' }">
			      <img src="../assets/imgs/firefox.png" class="image">
			      <div style="padding: 14px;">
			        <span>Firefox</span>
			        <div class="bottom clearfix">
			  ...
			  <el-col :span="2">
			  	<el-card :body-style="{ padding: '5px' }">
			      <img src="../assets/imgs/ie.png" class="image">
			      <div style="padding: 14px;">
			        <span>IE</span>
			        <div class="bottom clearfix">
